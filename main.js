...
function createResponsiveMenuHTML() {
    return `
        <div class="logo hide-mobile"><img src="./img/Fotogram_Logo.svg" alt ="Fotogram Logo"></div>
        <div class="logo hide-desktop"><img src="./img/favicon.svg" alt ="Fotogram Logo"></div>
...
if (currentPath.includes('datenschutz.html')) {
    document.querySelector('.datenschutz-link')?.classList.add('hide-link');
}

if (currentPath.includes('index.html')) {
    document.querySelector('.index-link')?.classList.add('hide-link');
}